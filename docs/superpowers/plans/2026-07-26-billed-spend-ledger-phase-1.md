...
| §8 failure modes (unknown ids, bad amount, duplicate, FX outage, archived, readonly) | 4, 5, 7, 8 |
| §9 double-count guard, mixed batch, key derivation, dated FX, architecture, frontend filter | 1, 2, 3, 5, 6 |
